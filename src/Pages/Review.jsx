...
const creators = [
  ...
  },
  {
    ...
    thumbnail:
      "https://cdn1.suno.ai/Suno+Timbaland+Cover+Edit+4+(1)+-+Smaller+Thumbnail.png",
  },
  {
...
export default function CreatorShowcase() {
  ...
  return (
    <div className=" text-white px-6 font-inter">
      {/* Section title */}
      <motion.div
        className="mx-auto max-w-[349px] text-center md:max-w-[744px]"
      ...
      >
        <h1 className="font-inter font-medium select-none whitespace-pre-wrap text-[35px] leading-[35px] lg:text-[72px] lg:leading-16 ">
          Explore and get inspired
        </h1>
        <h2 className="mt-4 text-4 text-white/70 max-w-[390px] mx-auto text-center text-[15px] leading-6 md:text-[18px]">
      ...
      <motion.div
        className="mx-auto mt-[50px] max-w-[1254px] flex gap-5 overflow-x-auto"
        ...
        {creators.map((creator, index) => (
          ...
          >
            ...
            <div className="relative">
              <video
                src={creator.video}
                className="h-[410px] w-full rounded-[20px] object-cover"
