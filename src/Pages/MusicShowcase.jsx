...
export default function MusicShowcase() {
  ...
  const songs = [
    {
      ...
      artist: "XAVI",
      image:
        "https://cdn2.suno.ai/6ac66ed1-da65-4715-986b-eec035c18d95.jpeg?width=360",
      plays: "32K",
      likes: "1.0K",
    },
    {
      ...
      image:
        "https://cdn2.suno.ai/image_5a40e16b-0c5a-40ce-90ac-50b1f8e39d0e.jpeg?width=360",
      plays: "22K",
      likes: "721",
    },
    {
      ...
      artist: "bleeder",
      image:
        "https://cdn2.suno.ai/ba1cfca8-c38f-44fa-b766-23c9a93e525f.jpeg?width=360",
      plays: "7.3K",
      likes: "510",
    },
    {
      ...
      artist: "DeeBeetttZZ",
      image:
        "https://cdn2.suno.ai/image_756dd139-4cba-4e40-b29c-03ace1c69673.jpeg?width=360",
      plays: "44K",
      likes: "1.0K",
    },
    {
  ...
  return (
    <section className="text-white py-20 px-10 ">
      ...
      <motion.div
        ref={ref}
        className="mt-10 flex  mb-0 w-full  md:mt-[60px] scrollbar-hide md:mb-[150px] overflow-x-auto  gap-10 h-[380px]"
        initial={{ opacity: 0, y: 50 }}
        ...
        {songs.map((song) => (
          ...
          >
            ...
            <div className="mt-2.5 flex items-center gap-1">
              ...
              <p className="flex-1 text-[11.685px] leading-[15.581px] font-medium">
                {song.artist}
              </p>
            </div>
          </div>
